...
<div class="flex items-center space-x-4 p-4 bg-gray-100 rounded-md shadow-md">
  <img src="../assets/flags/China.png" alt="B1" class="rounded-md w-[150px] h-[130px]">
  <div>
    <h2 class="text-lg font-semibold">Beijing - China</h2>
    <p class="text-gray-700">Date: {{getdate}}</p>
...
<div class="flex items-center space-x-4 p-4 bg-gray-100 rounded-md shadow-md">
  <img src="../assets/flags/Morocco.png" alt="M1" class="rounded-md w-[150px] h-[130px]">
  <div>
...
export default {
  ...
  computed: {
    ...
    getdate () {
      return this.task?.[0]?.done?.[0]?.date || ''
    }
  }
}
</script>
